...
for i=1:length(celltype)
    ...
    for n_abf=nexample:(-1):1
        ...
        xlim=[t_stim(1)-0.2,t_stim(end)+0.2];
...
%             axis off
        ...
        if n_abf<3
            plot([xl(2)-0.1,xl(2)],[yl(2)-3,yl(2)-3],'-k','LineWidth',2);%scale bar for time
            plot([xl(2)-0.1,xl(2)-0.1],[yl(2)-3,yl(2)],'-k','LineWidth',2);%scale bar for voltage
