function [A] = fPlotRasterPSTH_ASession(activities_data,activity_form,ind_tr_1,Data_extract,SavedCaTrials,frameNumTime,behEventAlign,masklick,i_selectivity,behEventSort,indTrial2include,savename_fig,title_fig,trialTypeStr)
