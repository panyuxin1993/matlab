function [savename,Data_extract] = fDataExtract(Cover_option,CurrFolder,filename_pattern)
%FDATAEXTRACT ref data_extract_ZL_pyx
...
%filename_pattern='\*imaging.mat';
savePath =[CurrFolder '\'];
files = dir(strcat(CurrFolder,filesep,filename_pattern));
...
%     Data_extract.Determine_boundary = DetBundary_frequency;
    ...
    savename=[fn(1:end-4),'_Virables','.mat'];
end
