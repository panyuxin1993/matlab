function [Data_extract] = fExtractBehMat2Struct(CurrFolder,filename_motif)
%FEXTRACTBEHMAT2STRUCT extract beh mat file to a struct, each variable as a
%vector rather than a struct array with each trial a struct
%   modified from data_extract_ZL_pyx.m
%filename_motif- 'imaging','FP' etc.
%%//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
%%%/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
% CurrFolder = 'H:\2P\pyx209_20190613\im_data_reg\result_save';% rootpath='F:\FP\pyx241_20191130';
% savePath = [CurrFolder '\Data_Virables\'];
% if ~exist('Data_Virables')
%     mkdir('Data_Virables');
% end
savePath =[CurrFolder '\'];
files = dir(strcat(CurrFolder,'\*',filename_motif,'.mat'));
