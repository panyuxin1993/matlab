...
cd 'F:\pyx196_20190731\im_data_reg_cpu\result_save';
CurrFolder = pwd;
rootname='pyx196_20190731';
...
%             hold on;
    ...
    saveas(A,[CurrFolder,'\',savefolder,'\',rootname,'ROI-',num2str(roiNo),'-algin to ',behEventAlign,'-sort ',behEventSort,'colorplot.jpg'],'jpg');
    saveas(figMeanTrace,[CurrFolder,'\',savefolder,'\',rootname,'ROI-',num2str(roiNo),'-algin to ',behEventAlign,'-sort ',behEventSort,'mean trace.jpg'],'jpg');
    close all;
end
