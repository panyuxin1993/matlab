    ...
    for i=1:size(Tchoose,1)
        ...
        for i_activity_type=1:length(activity_typePool)
            ...
            for i_align=1:length(behEventAlignPool)
                ...
                [figRaster_case(i_align),figMean_case(i_align)]=fPlotRasterMean(cellActivityByTrialType,meanActivityByTrialType,behEventAlign,objsession.metadata.frT);
            end
...
%assist function
function [A,figMean]=fPlotRasterMean(cellActivityByTrialType_combine,meanActivityByTrialType_combine,behEventAlign,frT)
...
function [figRaster]=fRasterMultiAlign(cellActivityByTrialType_combine,meanActivityByTrialType_combine,behEventAlignPool,frT)
%Input-
