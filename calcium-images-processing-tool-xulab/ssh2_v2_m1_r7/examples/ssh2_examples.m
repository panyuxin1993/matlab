...
HOSTNAME = '10.10.45.238';
USERNAME = 'omnisky';
PASSWORD = 'linux123';
% Basic Connection: to make a simple, one-time use, connection.
command_output = ssh2_simple_command(HOSTNAME,USERNAME,PASSWORD,'ls');
...
command_output = ssh2_simple_command(HOSTNAME,USERNAME,PASSWORD,'ls ',1);
