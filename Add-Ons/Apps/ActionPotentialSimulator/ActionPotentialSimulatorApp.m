classdef ActionPotentialSimulatorApp < handle
    %
    % Usage:
    %     app.ActionPotentialSimulatorApp
    ...
    properties (Constant)
        AppPathBase = {'/ActionPotentialSimulator'};
        AppClass = 'ActionPotentialSimulatorApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = ActionPotentialSimulatorApp()
        ...
        function startApp(obj)
            ...
            mlock;
            ActionPotentialSimulatorApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'AP')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong AP
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'AP').getString, ...
