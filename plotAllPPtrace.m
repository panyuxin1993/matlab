...
times=3;
savepathPPR=['D:\data3\PPR summary\PPR\'];
...
%                 end
    ...
    saveas(figraw,[savepathPPR,celltype{n_celltype},'-all cases.fig'],'fig');
    saveas(figraw,[savepathPPR,celltype{n_celltype},'-all cases.png'],'png');
    saveas(figraw,[savepathPPR,celltype{n_celltype},'-all cases.eps'],'epsc');
end
