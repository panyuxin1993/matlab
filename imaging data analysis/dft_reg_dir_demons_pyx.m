function dft_reg_dir_demons_pyx(src_dir, save_path, main_fname, targetImage, varargin)
...
% for i = 1:length(datafiles)
    ...
    save_name = [save_path filesep  file_basename 'dftRegDemons_' fname(end-6:end-4) '.tif'];
...
%     else        
        ...
        [im_dft_reg] = dft_reg_demons(im_s, im_tg,[]);
        t=toc(function_t);
        total_time_CPU(i)=t;
        disp(t);       
%     end
