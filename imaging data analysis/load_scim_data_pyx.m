function [ im, header ] = load_scim_data_pyx( filename,varargin )
...
% -NX 2013-11-6
% 
% Update for 2 channel simultaneously recording, saved file alternatively
% switch between two channels. 
% varargin{3}, specified  how many channels 
% -pyx 2019-11
...
if length(varargin)>2 && ~isempty(varargin{1})
    nchannel=varargin{3};
    frame_inds=varargin{1}(1): nchannel: varargin{1}(2);
elseif length(varargin)>2 && isempty(varargin{1})
    nchannel=varargin{3};
    frame_inds=1: nchannel: numImages;
end
